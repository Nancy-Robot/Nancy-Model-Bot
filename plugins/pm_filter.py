...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text=f"🔱 {file.file_name} 🔱",url="https://t.me/+CeY_RGCtK1g0ZWQ9")]
        )
    else:
        btn.append(
        ...
        btn.insert(0,
            [InlineKeyboardButton(text=f"⭕️ {file.file_name} ⭕️",url="https://t.me/+CeY_RGCtK1g0ZWQ9")]
        )
